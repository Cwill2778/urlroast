      ...
      <section style={{ 
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            <a href="tel:7068448193" style={{ display: 'flex', alignItems: 'center', gap: '1rem', color: '#fff', textDecoration: 'none', fontSize: '1.1rem', transition: 'color 0.2s' }} className="contact-link">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#d4af37" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="contact-icon"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg> 
              (706) 844-8193
            </a>
            <a href="mailto:c.brianna@cronantech.com" style={{ display: 'flex', alignItems: 'center', gap: '1rem', color: '#fff', textDecoration: 'none', fontSize: '1.1rem', transition: 'color 0.2s' }} className="contact-link">
              <Mail size={24} color="#d4af37" className="contact-icon" /> c.brianna@cronantech.com
            </a>
          </div>
        </motion.div>
